  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center px-6 md:px-20">
      ...
      <div className="relative z-20 max-w-3xl text-white flex flex-col items-start">
        ...
        >
          About <span className="text-[var(--turaath-gold)] drop-shadow-lg">Turaath International School</span>
        </motion.h1>
        ...
        >
          At Turaath, we nurture confident learners who excel academically, embrace cultural values, and thrive in modern learning environments. Explore how we empower students from Nursery to Secondary levels.
        </motion.p>
      </div>
    </section>
  );
